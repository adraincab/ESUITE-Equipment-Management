...
nnoremap <silent>  j = :InsertBothGetterSetter
nnoremap  o :Buffers
nnoremap  fa za
nnoremap  fC zC
nnoremap  fc zc
nnoremap  fo zo
nnoremap <silent>  s :sh
nnoremap <silent>  t :NERDTreeToggle
nnoremap <silent>  vs :source $MYVIMRC
nnoremap <silent>  ve :vs $MYVIMRC
...
nnoremap q: :q
nnoremap <silent> td :tabclose
nnoremap <silent> tm :tabm 
nnoremap <silent> tn :tabnext 
nnoremap <silent> tt :tabfind 
nnoremap <silent> tl :tablast
nnoremap <silent> tj :tabprev
nnoremap <silent> tk :tabnext
nnoremap <silent> th :tabfirst
...
set ruler
set runtimepath=~/.vim,~/.fzf/,~/.vim/plugged/dart-vim-plugin/,~/.vim/plugged/fzf.vim/,~/.vim/plugged/kotlin-vim/,~/.vim/plugged/nerdtree/,~/.vim/plugged/lightline.vim/,~/.vim/plugged/rust.vim/,~/.vim/plugged/tabular/,~/.vim/plugged/tlib/,~/.vim/plugged/tlib_vim/,~/.vim/plugged/typescript-vim/,~/.vim/plugged/vim-addon-mw-utils/,~/.vim/plugged/vim-colorschemes/,~/.vim/plugged/vim-commentary/,~/.vim/plugged/vim-eunuch/,~/.vim/plugged/vim-fugitive/,~/.vim/plugged/vim-go/,~/.vim/plugged/vim-multiple-cursors/,~/.vim/plugged/vim-repeat/,~/.vim/plugged/vim-snipmate/,~/.vim/plugged/vim-surround/,~/.vim/plugged/vim-vue/,/usr/share/vim/vimfiles,/usr/share/vim/vim81,/usr/share/vim/vimfiles/after,~/.fzf,~/.vim/plugged/rust.vim/after,~/.vim/plugged/tabular/after,~/.vim/plugged/vim-snipmate/after,~/.vim/after
set shiftwidth=2
set smartcase
...
argglobal
%argdel
$argadd src/app.module.ts
$argadd src/auth/auth.controller.ts
$argadd src/auth/auth.service.ts
$argadd src/config/config.controller.ts
$argadd src/database/database.controller.ts
$argadd src/db/redis.ts
$argadd src/entity/config.ts
$argadd src/entity/equipment.ts
$argadd src/entity/user.ts
$argadd src/equipment/equipment.controller.ts
$argadd src/equipment/equipment.service.ts
$argadd src/helpers/bcrypt.ts
$argadd src/main.ts
$argadd src/ormconfig.json
$argadd src/pipes/validation.pipe.ts
$argadd src/types/requests.ts
$argadd src/types/types.ts
$argadd src/user/user.controller.ts
$argadd database.json
$argadd nest-cli.json
$argadd ormconfig.json
$argadd package.json
$argadd package-lock.json
$argadd tsconfig.build.json
$argadd tsconfig.json
$argadd tslint.json
$argadd test/app.e2e-spec.ts
$argadd test/jest-e2e.json
edit test/app.e2e-spec.ts
...
argglobal
if bufexists("test/app.e2e-spec.ts") | buffer test/app.e2e-spec.ts | else | edit test/app.e2e-spec.ts | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe 'vert 2resize ' . ((&columns * 79 + 79) / 159)
tabnext 1
badd +32 src/app.module.ts
badd +58 src/auth/auth.controller.ts
badd +17 src/auth/auth.service.ts
badd +83 src/config/config.controller.ts
badd +43 src/database/database.controller.ts
badd +34 src/db/redis.ts
badd +1 src/entity/config.ts
badd +1 src/entity/equipment.ts
badd +1 src/entity/user.ts
badd +22 src/equipment/equipment.controller.ts
badd +1 src/equipment/equipment.service.ts
badd +1 src/helpers/bcrypt.ts
badd +8 src/main.ts
badd +1 src/ormconfig.json
badd +1 src/pipes/validation.pipe.ts
badd +1 src/types/requests.ts
badd +1 src/types/types.ts
badd +107 src/user/user.controller.ts
badd +1 database.json
badd +1 nest-cli.json
badd +1 ormconfig.json
badd +14 package.json
badd +1 package-lock.json
badd +1 tsconfig.build.json
badd +1 tsconfig.json
badd +1 tslint.json
badd +14 test/app.e2e-spec.ts
badd +1 test/jest-e2e.json
badd +203 ~/.dotfiles/vim/vimrc
badd +1 .env
